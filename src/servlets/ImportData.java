...
public class ImportData extends HttpServlet {
	 ...
	 * Response: doPost
	 * ----------------
	 * Responds to POST from home.jsp by dispatching data to data.jsp.
	 */
	protected void doPost(HttpServletRequest request,
		...
		String relativeWebPath = "../../data/small_movie_dataset.dsv";
		String absoluteDiskPath = getServletContext().getRealPath(relativeWebPath);
		readIntoDatabase(absoluteDiskPath, db);
	 ...
	 * ---------------------------------
	 * Reads in data from the top 100 movies file,
	 * and makes documents with the title and the corresponding movie id.
	 */
	private void readIntoDatabase(String filename, DB db) {
		...
		try {
			...
			while ((currentLine = br.readLine()) != null) {
				...
				// Tokenizes the string over bar delimiters, getting name & ID
				// num.
			...
			System.out.println("An error ocurred while reading file: "
					+ filename + " with a BufferedReader.");
